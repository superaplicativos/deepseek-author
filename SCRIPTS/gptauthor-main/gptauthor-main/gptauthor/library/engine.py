...
def do_writing(llm_config):
    ...
    with open(output_folder / "_synopsis_prompt.txt", "w", encoding="utf-8") as f:
        f.write(f"{synopsis_system}")
        f.write("\n---\n")
        f.write(f"{synopsis_prompt}\n")
    with open(output_folder / "synopsis_response_original.txt", "w", encoding="utf-8") as f:
        f.write(f"{synopsis_response.strip()}")
    with open(output_folder / synopsis_response_user_edited_filename, "w", encoding="utf-8") as f:
        f.write(f"{synopsis_response.strip()}")
    with open(output_folder / "_chapter_prompt_format.txt", "w", encoding="utf-8") as f:
        f.write(prompts.get_prompt("expand-chapter-first", llm_config))
        f.write("\n---\n")
        f.write(prompts.get_prompt("expand-chapter-next", llm_config))
    with open(output_folder / "_synopsis.txt", "w", encoding="utf-8") as f:
    ...
    # ------------------------------------------------------------------------------
    with open(output_folder / synopsis_response_user_edited_filename, "r", encoding="utf-8") as f:
    ...
    for i in pbar:
        ...
        with open(output_folder / f"chapter_{chapter_number}.txt", "w", encoding="utf-8") as f:
    ...
    with open(output_folder / "_whole_book.md", "w", encoding="utf-8") as f:
        f.write(whole_book)
    ...
    with open(output_folder / "_whole_book.html", "w", encoding="utf-8") as f:
        f.write(whole_book_html)

    with open(output_folder / "__finished.txt", "w", encoding="utf-8") as f:
